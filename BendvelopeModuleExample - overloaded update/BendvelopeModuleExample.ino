...
void setup() 
{
	...
	//Setting envelope
	bendvelope.attack( 200, 100 );// 0 to 255 for length, -128 to 127
	bendvelope.decay( 200, 60 );// 0 to 255 for length, -128 to 127
	bendvelope.sustain( 200 );// 0 to 255 for level
	bendvelope.release( 200, 80 );// 0 to 255 for length, -128 to 127
